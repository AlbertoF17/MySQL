-- 1. Añadir una entrada a la base de datos para indicar que "Suministros Skellington" (code
...
DELETE FROM provee WHERE ID_Pieza = 4 AND ID_Proveedor = "RBT";

-- 4. Actualiza la base de datos para reflejar que "Corporacion Susan Calvin" (code "RBT") no
-- proveerá ninguna pieza (el proveedor debe permanecer en la base de datos).
